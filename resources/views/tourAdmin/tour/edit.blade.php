...
@section('content')
    <div class="card col-10">
        ...
        <div class="card-body">
        <form action="{{ route('tourAdmin.tour.update', $tour) }}" method="post">
            @csrf
            @method('PATCH')
            <div class="row">
                <div class="col-md-12">
                        ...
                        @if(isset($hotels))
                            <select name="hotel_id" class="form-control selectpicker col-9 @if($errors->tourCreation->first('hotel')) is-invalid @endif" data-style="btn btn-link">
                                ...
                                @foreach($hotels as $hotel)
                                    <option value="{{ $hotel->id }}" @if($hotel->id == $tour->hotel->id) selected @endif>
                                        {{ $hotel->name }}
                                    </option>
                                @endforeach
                            </select>
            ...
            <div class="row">
                @component('components.tourAdmin.tour.edit-field', [
            ...
            <div class="row">
                ...
                @component('components.tourAdmin.tour.edit-select', [
                                ...
                                'CHECK'   => $tour->marriage_certificates,
                                ])
                @endcomponent
                        ...
                        <div class="col-md-8">
                            <div class="row container">
                                ...
                                @component('components.tourAdmin.tour.edit-field', [
                                                ...
                                                'FIELD'    => $tourService->tour_service_price,
                                                ])
                                @endcomponent
                            </div>
                        </div>
                        @component('components.tourAdmin.tour.edit-delete', [
                            'NAME' => 'delete_tour_services[]'
                            ])
                        @endcomponent
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row container">
                            ...
                            @component('components.tourAdmin.tour.edit-field', [
                                            ...
                                            'TYPE'   => 'text',
                                            'ERROR'  => 'room_service',
                                            'FIELD'    => $roomService->room_service,
                                            ])
                            @endcomponent
                            ...
                            @component('components.tourAdmin.tour.edit-field', [
                                            ...
                                            'FIELD'    => $roomService->room_service_price,
                                            ])
                            @endcomponent
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row container">
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'TYPE'    => 'text',
                                        'ERROR'   => 'vehicle',
                                        'FIELD'    => $transportationService->vehicle,
                                        ])
                        @endcomponent
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'FIELD'    => $transportationService->transition_type,
                                        ])
                        @endcomponent
                    ...
                    <div class="row container">
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'TYPE'    => 'text',
                                        'ERROR'   => 'company',
                                        'FIELD'    => $transportationService->company,
                                        ])
                        @endcomponent
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'FIELD'    => $transportationService->transition_service_price,
                                        ])
                        @endcomponent
                    ...
                    <div class="row container">
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'FIELD'    => $transportationService->origin_address,
                                        ])
                        @endcomponent
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'FIELD'    => $transportationService->destination_address,
                                        ])
                        @endcomponent
                    ...
                    <div class="row container">
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'CLASS'     => '',
                                        'FIELD'    => $transportationService->departure_time,
                                        ])
                        @endcomponent
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                        ...
                                        'ERROR'     => 'arrival_time',
                                        'CLASS'     => '',
                                        'FIELD'    => $transportationService->arrival_time,
                                        ])
                        @endcomponent
                    ...
                    <div class="row container">
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                    ...
                                    'TYPE'      => 'text',
                                    'ERROR'     => 'conditions',
                                    'FIELD'    => $transportationService->conditions,
                                    ])
                        @endcomponent
                        ...
                        @component('components.tourAdmin.tour.edit-field', [
                                    ...
                                    'FIELD'    => $transportationService->percentage_reduction,
                                    ])
                        @endcomponent
                ...
                @component('components.tourAdmin.tour.edit-delete', [
                            'NAME' => 'delete_transportation_services[]'
                            ])
                @endcomponent
            </div>
            ...
            <a href="{{ route('tourAdmin.tour.index') }}" type="submit" class="btn btn-danger pull-right"
               onclick="return confirm('{{ __('tourAdmin.alerts.tour.cancel_edit') }}');">{{ __('tourAdmin.list.cancel') }}</a>
            <button type="submit" class="btn btn-success float-right"
                    onclick="return confirm('{{ __('tourAdmin.alerts.tour.confirm_edit') }}');">{{ __('tourAdmin.edit.submit') }}</button>
        </form>
    </div>
@endsection
...
@push('js')
    ...
    function addService() {
        ...
        "                        </div>\n" +
        "                    </div>\n" +
        "                   <input type=\"text\" hidden value=\"1\" name=\"add_tour_service[]\">\n" +
    ...
    function addRoomService() {
        ...
        "                         </div>\n" +
        "                       </div>\n" +
        "                   <input type=\"text\" hidden value=\"1\" name=\"add_room_service[]\">\n" +
        "                       <a onclick=\"deleteRow()\" class=\"col-1 mt-5 pt-1 remove\" style=\"cursor: pointer;\">\n" +
        "                           <i class=\"material-icons text-danger\">delete</i>\n" +
        "                       </a>\n" +
        "                   </div>\n" +
    ...
    function addTransportationService() {
        var transportation_service = "<div>\n" +
            ...
            "                    </div>\n" +
            "                        </div>\n" +
            "                   <input type=\"text\" hidden value=\"1\" name=\"add_transportation_service[]\">\n" +
