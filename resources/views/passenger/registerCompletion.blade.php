    ...
    <form action="{{ route('register.passenger.update', $passenger) }}" method="POST">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input name="email" type="email" placeholder="{{ __('passenger.register_completion.email') }}" class="form-control col-8 @if($errors->passengerCompletion->first('email')) is-invalid @endif">
            ...
            <div class="form-group bmd-form-group col-md-6">
                ...
                <input name="telephone_number" type="text" placeholder="{{ __('passenger.register_completion.telephone_number_description') }}" class="form-control col-8 @if($errors->passengerCompletion->first('telephone_number')) is-invalid @endif">
        ...
        <div class="form-row">
            <div class="form-group bmd-form-group col-md-6">
                ...
                <input name="national_code" type="text" placeholder="{{ __('passenger.register_completion.national_code') }}" class="form-control col-8 @if($errors->passengerCompletion->first('national_code')) is-invalid @endif">
            ...
            <div class="form-group col-md-6">
                ...
                <input name="birthday" type="date" class="form-control col-8 @if($errors->passengerCompletion->first('birthday')) is-invalid @endif">
