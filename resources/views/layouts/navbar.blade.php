                ...
                <div class="card card-signup card-plain">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('login') }}" class="form" method="POST">
                                ...
                                <div class="form-group bmd-form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="mobile_number" type="text"
                                               placeholder="{{ __('navbar.login.mobile') }}"
                                ...
                                <div class="form-group bmd-form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="password" type="password"
                                               placeholder="{{ __('navbar.login.password') }}"
                            ...
                            <button type="submit"
                                    class="container text-center ml-2 btn btn-primary btn-link btn-wd btn-lg">
                                ...
                                <div class="form-group bmd-form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="first_name" type="text"
                                               placeholder="{{ __('navbar.register.first_name') }}"
                                               value="{{ old('first_name') }}"
                                               class="form-control @if($errors->passengerRegister->first('first_name')) is-invalid @endif">
                                ...
                                <div class="form-group bmd-form-group">
                                    <div class="input-group">
                                        ...
                                        <input name="last_name" type="text"
                                               placeholder="{{ __('navbar.register.last_name') }}"
                                               value="{{ old('last_name') }}"
                                               class="form-control @if($errors->passengerRegister->first('last_name')) is-invalid @endif">
                                ...
                                <div class="card-body">
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="mobile_number" type="text"
                                                   placeholder="{{ __('navbar.login.mobile') }}"
                                                   value="{{ old('mobile_number') }}"
                                                   class="form-control @if($errors->passengerRegister->first('mobile_number')) is-invalid @endif">
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="password" type="password"
                                                   placeholder="{{ __('navbar.login.password') }}"
                                                   class="form-control @if($errors->passengerRegister->first('password')) is-invalid @endif">
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="password_confirmation" type="password"
                                                   placeholder="{{ __('navbar.login.password_confirmation') }}"
                                                   class="form-control @if($errors->passengerRegister->first('password')) is-invalid @endif">
                                ...
                                <div class="card-body">
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="first_name" id="ro" type="text"
                                                   placeholder="{{ __('navbar.register.first_name') }}"
                                                   value="{{ old('first_name') }}"
                                                   class="form-control @if($errors->tourAdminRegister->first('first_name')) is-invalid @endif">
                                    ...
                                    <div class="form-group bmd-form-group">
                                        <div class="input-group">
                                            ...
                                            <input name="last_name" type="text"
                                                   placeholder="{{ __('navbar.register.last_name') }}"
                                                   value="{{ old('last_name') }}"
                                                   class="form-control @if($errors->tourAdminRegister->first('last_name')) is-invalid @endif">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group bmd-form-group">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text"><i class="material-icons">call</i>
                                                    </div>
                                                </div>
                                                <input name="mobile_number" type="text"
                                                       placeholder="{{ __('navbar.login.mobile') }}"
                                                       value="{{ old('mobile_number') }}"
                                                       class="form-control @if($errors->tourAdminRegister->first('mobile_number')) is-invalid @endif">
                                            ...
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text"><i
                                                            class="material-icons">lock_outline</i></div>
                                                </div>
                                                <input name="password" type="password"
                                                       placeholder="{{ __('navbar.login.password') }}"
                                                       class="form-control @if($errors->tourAdminRegister->first('password')) is-invalid @endif">
